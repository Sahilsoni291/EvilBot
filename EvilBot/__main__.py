...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/b1ae67fad00c60d51a5f2.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *Dawn*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/Dawn_group_manager_bot?startgroup=true"),
    ],
     [
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *Dawn* [👿](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
